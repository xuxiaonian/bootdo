...
public interface UserMapper {
	...
	"select * from C_SYS_USER " +
			"</script>")
	List<SysUserDO> list1(Map<String,Object> param);
//		@Select("select PHONE as phone ,PASSWORD as password,PHONE_BIND_STATE as status  from ACT.TB_USER_INFO where PHONE = #{phone}" )
